...
class Sag {
  ...
  private function procPacket($method, $url, $data = null, $headers = array()) {
	...
	// Filter the use of the Expect header since we don't support Continue headers, if the Expect header is set.
	if (isset($headers['expect']) || isset($headers['Expect'])) {
     ...
     * different logic paths above, and if cookie is set.
     */
